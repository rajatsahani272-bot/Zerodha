...
function Brokerage() {
    return ( 
            ...
            <div className='row p-5 mt-5  text-center border-top border-bottom'>
                <div className='col-8 p-4'>
                    <a href=''>  <h3 className='fs-5 mb-5' >Brokerage calculator</h3>
                    </a>
  ...
  <li>
    If the account is in debit balance, any order placed will be charged ₹40 per executed order instead of ₹20 per executed order.
                ...
                <div className='col-4 p-4'>
                   <a href=''><h3 className='fs-5 mb-5'>List of charges</h3></a>
                </div>
